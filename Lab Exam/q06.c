/* Write a C program to implement the following on priority queue, consisting of three queues:  
i. insert() – start inserting the elements into the queues from the first queue. 
