/* Write a C function search(l,x) that accepts a pointer 'l' to a list of integers and an integer x and returns a pointer to a node containing x, if it exists
or the null pointer otherwise. Write another function srchinsrt(l,x), that adds 'x' to 'l' if it is not found and always returns a pointer to a node containing 
'x'. */
#include<stdio.h>
#include<stdlib.h>
